...
public record AnalysisScopeDecisionRequest(
    ...
    public AnalysisScopeDecisionRequest {
    ...
    public static AnalysisScopeDecisionRequest empty() {
        return new AnalysisScopeDecisionRequest(
                List.of(),
                List.of(),
                List.of(),
                List.of(),
